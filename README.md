...
- **Vercel AI SDK** powers all AI features with streaming responses
...
### AI Fitness Coach
The sidebar chatbot uses the `useChat` hook from the AI SDK to provide real-time responses. It sends your quiz data with every message so the AI understands your fitness context. Conversations are stored in the database with Row Level Security enabled.
